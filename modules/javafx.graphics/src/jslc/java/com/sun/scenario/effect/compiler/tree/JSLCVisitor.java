...
public class JSLCVisitor extends JSLBaseVisitor<Tree> {
    ...
    public Expr visitPrimary_expression(JSLParser.Primary_expressionContext ctx) {
        if (ctx.IDENTIFIER() != null) {
            ...
            return tm.literal(Types.INT, Integer.valueOf(ctx.INTCONSTANT().getText()));
        } else if (ctx.FLOATCONSTANT() != null) {
            return tm.literal(Types.FLOAT, Float.valueOf(ctx.FLOATCONSTANT().getText()));
        } else if (ctx.BOOLCONSTANT() != null) {
            return tm.literal(Types.BOOL, Boolean.valueOf(ctx.BOOLCONSTANT().getText()));
        } else if (ctx.e != null) {
